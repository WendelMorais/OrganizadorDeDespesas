<style>
     .teste:hover,  .teste:focus, .teste:active {
...
.Roda {
 ...
 padding-top: 20rem;
  ...
  <div class="d-flex" id="wrapper">
    ...
    <!-- Sidebar -->
    <div class="border-right border-dark" id="sidebar-wrapper" style="background-color:#373737;"> 
            <div class="sidebar-heading mt-3 text-light">Control Finance</div>
            <div class="list-group list-group-flush">
              <a href="cadastrar_dados" class="list-group-item list-group-item-action mt-3 rounded text-light teste" id="" style="background-color: #00a0a0;" >Cadastrar Produtos</a>
